...
#     - 2026-03-03: Updated arguments to match base class
...
class SUNDatasetPT(SUNDataset, Dataset):
    def __init__(
        ...
        ...     pass
        """
        super().__init__(root_dir, class_hierarchy, train, split_idx, n_samples,
                         hdf5_mode, image_size, preserve_aspect_ratio)
